...
class Securimage {
	...
	*/
	...
	function Securimage()
	{
		...
		$this->wordlist_file = 'image/captcha/words/words.txt';
		$this->use_wordlist  = false;

		$this->gd_font_file  = 'image/captcha/gdfonts/automatic.gdf';
		$this->use_gd_font   = false;
		$this->gd_font_size  = 24;
		$this->text_x_start  = 15;

		$this->ttf_file      = 'image/captcha/AHGBold.ttf';
    ...
    $this->text_color       = new Securimage_Color(0x3d, 0x3d, 0x3d);
		...
		$this->signature_font  = 'image/captcha/AHGBold.ttf';

		$this->audio_path   = 'image/captcha/audio/';
